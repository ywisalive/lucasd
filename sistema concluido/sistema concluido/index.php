...
<body class="bg-dark">
    <div class="container text-center">
        <div class="mt-5 mb-3">
            <img src="Recursos\logo.gif" alt="" width="700px">
        </div>
        <div>
            <h2 class="text-light">Bem vindo(a) a Infinity 3D</h2>
            <p class="text-light">Para comprar nossas peças apenas realize seu cadastro/login</p>
            ...
            <form action="Web/login.php" method="post">
                ...
                <a class="btn btn-warning btn-lg" href="Web/cadastrar.php">Cadastrar</a>
